<?php
 ...
 while($row = mysqli_fetch_array($timetables)) {
   ...
   echo "<tr>";
   echo "<td>".$row['name']."</td>";
   echo "<td id='year_t'>".$row['year']."</td>";
   echo "<td id='semester_t'>".$row['semester']."</td>";
   echo "<td id='section_t'>".$row['section']."</td>";
   echo "<td>";
   echo "<a id='delete' href='#' style='text-decoration:none;'><button id='del_timetable' style='background-color:green; color:black;' onclick='deletetimetables();'>Delete</button></a>";
   echo "</td>";
   echo "<td>";
